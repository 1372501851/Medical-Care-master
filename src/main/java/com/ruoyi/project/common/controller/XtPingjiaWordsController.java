...
//@Api(tags = "评价用语模块")
//@RestController
//@RequestMapping("/web/evaluationWords")
//public class XtPingjiaWordsController extends BaseController
//{
//    @Autowired
...
//    @GetMapping(value = "/{upingjiaWordsid}")
...
//	@DeleteMapping("/{upingjiaWordsids}")
