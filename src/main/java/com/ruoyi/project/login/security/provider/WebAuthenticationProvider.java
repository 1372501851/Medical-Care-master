...
public class WebAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        try {
            WebAuthenticationToken tokenReq = (WebAuthenticationToken) authentication;

            //通过账号密码查询登录人的信息
            UserDetails userDetails = webUserDetailsService.loadUserByUsername(tokenReq.getUsername());
