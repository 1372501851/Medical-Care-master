//package com.ruoyi.project.unipush.util;
//
...
//     * @param content
//     */
//    public AjaxResult pushToSingleByCid(String cid, String title, String content) {
...
//            // success
//            log.info("消息推送成功");
//            log.info("消息通知:{}",apiResult.getMsg());
//            log.info("消息数据:{}",apiResult.getData());
//            return AjaxResult.success(apiResult.getMsg(),apiResult.getData());
//        } else {
//            // failed
//            log.info("消息推送失败");
//            return AjaxResult.error("code:" + apiResult.getCode() + ", msg: " + apiResult.getMsg());
//
//        }
//    }
//
...
//     * @param content
//     */
//    public AjaxResult pushListByCid(List<String> cidList, String title, String content) {
//        //批量发送
...
//            return AjaxResult.error("推送：创建消息失败"+createApiResult.getMsg());
//        }
//        // 设置接收人信息
//        Audience audience = new Audience();
//        pushDTO.setAudience(audience);
...
//        if (apiResult.isSuccess()) {
//            // success
//            return AjaxResult.success(apiResult.getMsg());
//        } else {
//            // failed
//            return AjaxResult.error("code:" + apiResult.getCode() + ", msg: " + apiResult.getMsg());
//        }
...
//        notification1.setIntent("intent:#Intent;action=android.intent.action.oppopush;launchFlags=0x14000000;component=com.weixiaobao/io.dcloud.PandoraEntry;S.UP-OL-SU=true;S.title="+title+ ";S.content="+content+";S.payload=test;end");
//        //各厂商自有功能单项设置
